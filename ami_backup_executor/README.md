...
```python
 python3 ami_backup.py -r us-east-1 -d 10 -s true -c "#ami_bkp_lambda" -w "https://hooks.slack.com/*********/*****"
``` 
...
```python
 python3 ami_backup.py -r us-west-2 -d 5 
``` 
* Typing ```python3 ami_backup.py -h will give you the options```
